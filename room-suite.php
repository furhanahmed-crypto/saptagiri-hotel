      ...
      <div class="room-detail__layout">
        <aside class="room-detail__panel">
          ...
          <ul class="room-detail__facilities">
            ...
            <li class="room-detail__facility"><svg class="mt-0.5 h-4 w-4 shrink-0 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>Cookies basket &amp; sweet basket</li>
        ...
        <div class="room-detail__gallery" data-room-gallery>
          <div class="room-detail__hero-wrap">
            <img
              ...
              data-room-main
              src="assets/images/rooms/suite11-1024x683.jpg"
          ...
          <div class="room-detail__thumbs" role="tablist" aria-label="Suite photos">
            <button type="button" class="room-detail__thumb is-active" data-room-thumb aria-selected="true" aria-label="Suite living area">
              <img src="assets/images/rooms/suite11-1024x683.jpg" alt="Suite living area at Hotel Saptagiri" />
            </button>
            <button type="button" class="room-detail__thumb" data-room-thumb aria-selected="false" aria-label="Suite bedroom">
              <img src="assets/images/rooms/suite2-1024x683.jpg" alt="Suite bedroom at Hotel Saptagiri" />
            </button>
            <button type="button" class="room-detail__thumb" data-room-thumb aria-selected="false" aria-label="Suite interior">
              <img src="assets/images/rooms/suite4-1024x683.jpg" alt="Suite interior at Hotel Saptagiri" />
            </button>
          </div>
        </div>
      </div>
